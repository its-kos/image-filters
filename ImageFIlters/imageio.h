...
namespace image {
	...
	/*	
	 *	Load-able / Save-able interface.
	 * 
	 *	Classes that implement this interface can be loaded and written in any filename and format.
	 *	
	 *	In our case, images implement this so they can be loaded and saved in filenames and formats
	 *	of our liking.
	 */
	class ImageIO {
	protected:
